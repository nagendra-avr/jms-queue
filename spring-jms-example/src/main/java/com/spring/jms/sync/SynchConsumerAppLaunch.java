 ...
 *
 */
public class SynchConsumerAppLaunch {
	
	private static final Logger LOG = LoggerFactory.getLogger(SynchConsumerAppLaunch.class);
    ...
    /*	if (args.length > 0 && null != args[0] && !"".equals(args[0])) {
    	...
    	ApplicationContext context = new ClassPathXmlApplicationContext("/jms/synch/spring/consumer-jms-context.xml", SynchConsumerAppLaunch.class);
