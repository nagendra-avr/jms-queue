...
public class QueueReciever implements MessageListener {
  ...
  public static void main(String[] args) throws Exception {
    /*
     * if (args.length != 1) { System.out.println("Usage: java QueueReceive WebLogicURL"); return; }
     */
    InitialContext ic = getInitialContext("t3://localhost:7001");
    QueueReciever qr = new QueueReciever();
    qr.init(ic, QUEUE);
